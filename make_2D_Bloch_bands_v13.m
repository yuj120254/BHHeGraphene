...
strain_strings = ["00", "05", "10", "15", "16", "17", "18", "19", "20", "21",...
...
Julia_Params = dlmread(strcat('Julia_params00.txt'));
...
Qx = 6; 
Qy = 6;   % 1/2*(number of grid points along edges of Brillouin zone(MperiodsX/Ylat in Julia))  
...
% 
V_graphene = dlmread('V_graphene00.txt');
Julia_grid = dlmread('Julia_grid00.txt');
